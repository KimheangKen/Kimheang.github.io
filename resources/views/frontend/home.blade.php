...
<!-- Mirrored from ruvenpelka.com/demos/desmond-resume/dark/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 May 2021 15:08:34 GMT -->
...
<head>
    ...
    <!-- FontAwesome -->
    <link rel="stylesheet" href="{{ asset ('public/frontend/assets/plugins/font-awesome/css/fontawesome.min.css')}}">
    <link rel="stylesheet" href="{{ asset ('public/frontend/assets/plugins/font-awesome/css/brands.min.css')}}">

    <!-- Nivo Lightbox-->
    <link rel="stylesheet" href="{{ asset ('public/frontend/assets/plugins/nivo-lightbox/nivo-lightbox.css')}}" />
    <link rel="stylesheet" href="{{ asset ('public/frontend/assets/plugins/nivo-lightbox/themes/default/default.css')}}" />
    ...
    <link rel="stylesheet" href="{{ asset ('public/frontend/assets/css/themes.dark.css')}}">
    ...
    <script src="{{ asset ('public/frontend/assets/js/dense.js')}}"></script>

    <!-- Nivo Lightbox -->
    <script src="{{ asset ('public/frontend/assets/plugins/nivo-lightbox/nivo-lightbox.min.js')}}"></script>

    <!-- ScrollReveal -->
    <script src="{{ asset ('public/frontend/assets/js/scrollreveal.min.js')}}"></script>
                            ...
                            <div class="c-header__inner-header">
                                ...
                                <div class="c-header__avatar">
                                    <div class="a-header  c-avatar">
                                        <img class="c-avatar__img" src="{{ asset ('public/frontend/assets/images/header/avatar1.jpg')}}" alt="">
                                    </div><!-- /c-avatar -->
                                </div><!-- /c-header-avatar -->
                            ...
                            <div class="c-header__inner-content">
                                ...
                                <div class="c-header__top">
                                    ...
                                    <ul class="c-header__social-buttons  c-social-buttons">
                                        <li class="a-header">
                                            <a href="https://web.facebook.com/kimheang.ken" target="_blank" class="c-social-button  t-social-button">
                                                <i class="fab  fa-lg  fa-facebook-f"></i>
                                            </a>
                                        </li>
                                        <li class="a-header">
                                            <a href="https://www.instagram.com/kidgodddd" target="_blank" class="c-social-button  t-social-button">
                                                <i class="fab  fa-lg  fa-instagram"></i>
                                            </a>
                                        </li>
                                        <!-- <li class="a-header">
                                            <a href="https://twitter.com/_Ruven" target="_blank" class="c-social-button  t-social-button">
                                                <i class="fab  fa-lg fa-envelope"></i>
                                            </a>
                                        </li> -->
                ...
                <div class="o-section__container">
                    ...
                    <div class="o-section__content  t-section__content  o-section__full-bottom-space">
                        ...
                        <div class="o-grid  o-grid--gallery">
                            ...
                            <div class="o-grid__col-sm-6">
                                <a class="c-image-overlay  t-image-overlay  js-lightbox" href="{{ asset ('public/frontend/assets/images/portfolio/1_full.jpg')}}" data-lightbox-hidpi="" title="Musée du Louvre" data-lightbox-gallery="portfolio">
                                    <img src="{{ asset ('public/frontend/assets/images/portfolio/1_thumb.jpg')}}" alt="">
                            ...
                            <div class="o-grid__col-sm-6">
                                <a class="c-image-overlay  t-image-overlay  js-lightbox" href="{{ asset ('public/frontend/assets/images/portfolio/2_full.jpg')}}" data-lightbox-hidpi="" title="Tunnel Effect" data-lightbox-gallery="portfolio">
                                    <img src="{{ asset ('public/frontend/assets/images/portfolio/2_thumb.jpg')}}" alt="">
                                    <div class="c-image-overlay__content">
                                        <h3>
                                            Tunnel Effect
                                        </h3>
                            ...
                            <div class="o-grid__col-sm-6">
                                <a class="c-image-overlay  t-image-overlay  js-lightbox" href="{{ asset ('public/frontend/assets/images/portfolio/3_full.jpg')}}" data-lightbox-hidpi="" title="New York, New York" data-lightbox-gallery="portfolio">
                                    <img src="{{ asset ('public/frontend/assets/images/portfolio/3_thumb.jpg')}}" alt="">
                                    <div class="c-image-overlay__content">
                                        <h3>
                                            New York, New York
                                        </h3>
                            ...
                            <div class="o-grid__col-sm-6">
                                <a class="c-image-overlay  t-image-overlay  js-lightbox" href="{{ asset ('public/frontend/assets/images/portfolio/4_full.jpg')}}" data-lightbox-hidpi="" title="Sky High" data-lightbox-gallery="portfolio">
                                    <img src="{{ asset ('public/frontend/assets/images/portfolio/4_thumb.jpg')}}" alt="">
                                    <div class="c-image-overlay__content">
                                        <h3>
                                            Sky High
                                        </h3>
                            ...
                            <div class="o-grid__col-sm-6">
                                <a class="c-image-overlay  t-image-overlay  js-lightbox" href="{{ asset ('public/frontend/assets/images/portfolio/5_full.jpg')}}" data-lightbox-hidpi="" title="The Eiffel Tower" data-lightbox-gallery="portfolio">
                                    <img src="{{ asset ('public/frontend/assets/images/portfolio/5_thumb.jpg')}}" alt="">
                                    <div class="c-image-overlay__content">
                                        <h3>
                                            The Eiffel Tower
                                        </h3>
                            ...
                            <div class="o-grid__col-sm-6">
                                <a class="c-image-overlay  t-image-overlay  js-lightbox" href="{{ asset ('public/frontend/assets/images/portfolio/6_full.jpg')}}" data-lightbox-hidpi="" title="Reaching the Clouds" data-lightbox-gallery="portfolio">
                                    <img src="{{ asset ('public/frontend/assets/images/portfolio/6_thumb.jpg')}}" alt="">
                                    <div class="c-image-overlay__content">
                                        <h3>
                                            Reaching the Clouds
                                        </h3>
                        ...
                        <ul class="c-clients  o-content">
                            <li>
                                <a href="http://example.com/" target="_blank">
                                    <img src="{{ asset ('public/frontend/assets/images/clients/bbc.png')}}" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="http://example.com/" target="_blank">
                                    <img src="{{ asset ('public/frontend/assets/images/clients/disney.png')}}" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="http://example.com/" target="_blank">
                                    <img src="{{ asset ('public/frontend/assets/images/clients/github.png')}}" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="http://example.com/" target="_blank">
                                    <img src="{{ asset ('public/frontend/assets/images/clients/google.png')}}" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="http://example.com/" target="_blank">
                                    <img src="{{ asset ('public/frontend/assets/images/clients/html5.png')}}" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="http://example.com/" target="_blank">
                                    <img src="{{ asset ('public/frontend/assets/images/clients/kickstarter.png')}}" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="http://example.com/" target="_blank">
                                    <img src="{{ asset ('public/frontend/assets/images/clients/youtube.png')}}" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="http://example.com/" target="_blank">
                                    <img src="{{ asset ('public/frontend/assets/images/clients/vimeo.png')}}" alt="">
                                </a>
                            </li>
                        </ul><!-- /o-float-box -->
...
<!-- Mirrored from ruvenpelka.com/demos/desmond-resume/dark/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 May 2021 15:09:58 GMT -->
